...
import { useAddressTransactions } from "@/hooks/explorer/transactions";
...
type Transaction = ArrayType<
  NonNullable<ReturnType<typeof useAddressTransactions>["data"]>["data"]
>;
...
const WalletTransactionsTable: React.FC<WalletTransactionsTableProps> = ({
  ...
  const query = useAddressTransactions({
    date,
    address,
    ...
    <div className="m-2">
      <Card>
        <CardHeader className="gap-2">
          ...
          <CardHeading>
            {token.getSymbol()} Transactions for this address
          </CardHeading>
          <CardTimestamp
            date={

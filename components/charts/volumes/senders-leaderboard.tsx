...
import { useSenderLeaderboard } from "@/hooks/leaderboards";
import {
  Divider,
  Table,
  TableBody,
...
const SendersLeaderboard = () => {
  ...
  return (
    <Card>
      <CardHeader>
        <CardHeading>Senders Leaderboard</CardHeading>
      ...
      <CardBody className="p-0">
        <Table
          ...
          className="h-[25rem] overflow-x-auto rounded-xl bg-default scrollbar-thin"
          classNames={{
